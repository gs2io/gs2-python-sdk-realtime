...
from gs2_realtime_client.model import *


class DescribeGatheringPoolResult(object):
    ...
    def __getitem__(self, key):
        ...
        if key in items.keys():
            return items[key]
        return super(DescribeGatheringPoolResult, self).__getitem__(key)
