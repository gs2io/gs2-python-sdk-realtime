...
class DescribeGatheringPoolRequest(Gs2BasicRequest):

    class Constant(Gs2Realtime):
        FUNCTION = "DescribeGatheringPool"
    ...
    def __init__(self, params=None):
        ...
        """
        super(DescribeGatheringPoolRequest, self).__init__(params)
        if params is None:
    ...
    def with_page_token(self, page_token):
        ...
        :type page_token: unicode
        :return: this
        :rtype: DescribeGatheringPoolRequest
        """
